...
const api: BrowserAPI = {
  ...
  bookmarks: { list: (query) => ipcRenderer.invoke('bookmarks:list', query), create: (title, url, folderId) => ipcRenderer.invoke('bookmarks:create', title, url, folderId), delete: (id) => ipcRenderer.invoke('bookmarks:delete', id) },
  ...
  searchEngines: { list: () => ipcRenderer.invoke('search-engines:list'), setDefault: (id) => ipcRenderer.invoke('search-engines:set-default', id), create: (name, keyword, searchUrl) => ipcRenderer.invoke('search-engines:create', name, keyword, searchUrl) },
